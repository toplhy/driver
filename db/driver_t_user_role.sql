...
CREATE TABLE `t_user_role` (
  ...
  `rid` bigint(20) DEFAULT NULL COMMENT '角色',
  PRIMARY KEY (`id`),
  KEY `FK_uid` (`uid`),
  KEY `FK_rid` (`rid`),
  CONSTRAINT `FK_rid` FOREIGN KEY (`rid`) REFERENCES `t_role` (`id`) ON DELETE CASCADE,
...
INSERT INTO `t_user_role` VALUES (1,1,1),(2,2,2),(6,7,2),(8,9,2),(9,10,1),(10,11,2),(11,12,1),(12,13,1);
